...
| [Advanced Custom Fields (ACF)](https://wordpress.org/plugins/advanced-custom-fields/) | advanced-custom-fields | 6.2.5 |  | [https://www.advancedcustomfields.com](https://www.advancedcustomfields.com) |
| [All-in-One WP Migration](https://wordpress.org/plugins/all-in-one-wp-migration/) | all-in-one-wp-migration | 7.79 |  | [https://servmask.com/](https://servmask.com/) |
| [Atlas Content Modeler](https://wordpress.org/plugins/atlas-content-modeler/) | atlas-content-modeler | 0.26.1 |  | [https://developers.wpengine.com/](https://developers.wpengine.com/) |
...
| [Custom Post Type UI](https://wordpress.org/plugins/custom-post-type-ui/) | custom-post-type-ui | 1.15.1 |  | [https://github.com/WebDevStudios/custom-post-type-ui/](https://github.com/WebDevStudios/custom-post-type-ui/) |
| [Code Snippets](https://wordpress.org/plugins/code-snippets/) | code-snippets | 3.6.2 |  | [https://codesnippets.pro](https://codesnippets.pro) |
...
| [Faust.js](https://wordpress.org/plugins/faustwp/) | faustwp | 1.2.1 |  | [https://faustjs.org/](https://faustjs.org/) |
...
| [Post Type Switcher](https://wordpress.org/plugins/post-type-switcher/) | post-type-switcher | 3.2.2 |  | [https://wordpress.org/plugins/post-type-switcher](https://wordpress.org/plugins/post-type-switcher) |
| [Redirection](https://wordpress.org/plugins/redirection/) | redirection | 5.4.2 |  | [https://redirection.me/](https://redirection.me/) |
| [RSS Importer](https://wordpress.org/plugins/rss-importer/) | rss-importer | 0.3.2 |  | [https://wordpress.org/extend/plugins/rss-importer/](https://wordpress.org/extend/plugins/rss-importer/) |
| [Safe SVG](https://wordpress.org/plugins/safe-svg/) | safe-svg | 2.2.2 |  | [https://wordpress.org/plugins/safe-svg/](https://wordpress.org/plugins/safe-svg/) |
...
| [TablePress &#8211; Tables in WordPress made easy](https://wordpress.org/plugins/tablepress/) | tablepress | 2.2.5 |  | [https://tablepress.org/](https://tablepress.org/) |
| [The Events Calendar](https://wordpress.org/plugins/the-events-calendar/) | the-events-calendar | 6.3.1 |  | []() |
| [User Role Editor](https://wordpress.org/plugins/user-role-editor/) | user-role-editor | 4.64.1 |  | [https://www.role-editor.com](https://www.role-editor.com) |
| [User Switching](https://wordpress.org/plugins/user-switching/) | user-switching | 1.7.2 |  | [https://wordpress.org/plugins/user-switching/](https://wordpress.org/plugins/user-switching/) |
...
| [WPGraphQL](https://wordpress.org/plugins/wp-graphql/) | wp-graphql | 1.20.0 |  | [https://github.com/wp-graphql/wp-graphql](https://github.com/wp-graphql/wp-graphql) |
| [WP Search with Algolia](https://wordpress.org/plugins/wp-search-with-algolia/) | wp-search-with-algolia | 2.7.0 |  | [https://github.com/WebDevStudios/wp-search-with-algolia](https://github.com/WebDevStudios/wp-search-with-algolia) |
| [Login Lockdown &#8211; Protect Login Form](https://wordpress.org/plugins/login-lockdown/) | login-lockdown | 2.08 | True | [https://wploginlockdown.com/](https://wploginlockdown.com/) |
| [Polylang](https://wordpress.org/plugins/polylang/) | polylang | 3.5.3 | True | [https://polylang.pro](https://polylang.pro) |
...
| [WooCommerce](https://wordpress.org/plugins/woocommerce/) | woocommerce | 8.5.2 | True | [https://woo.com/](https://woo.com/) |
...
| wp-graphql-woocommerce | v0.19.0 | True | [https://github.com/wp-graphql/wp-graphql-woocommerce](https://github.com/wp-graphql/wp-graphql-woocommerce) |
