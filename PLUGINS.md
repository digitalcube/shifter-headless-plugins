...
| [Advanced Custom Fields (ACF)](https://wordpress.org/plugins/advanced-custom-fields/) | advanced-custom-fields | 6.2.0 |  | [https://www.advancedcustomfields.com](https://www.advancedcustomfields.com) |
| [All-in-One WP Migration](https://wordpress.org/plugins/all-in-one-wp-migration/) | all-in-one-wp-migration | 7.78 |  | [https://servmask.com/](https://servmask.com/) |
...
| [Custom Post Type UI](https://wordpress.org/plugins/custom-post-type-ui/) | custom-post-type-ui | 1.14.0 |  | [https://github.com/WebDevStudios/custom-post-type-ui/](https://github.com/WebDevStudios/custom-post-type-ui/) |
| [Code Snippets](https://wordpress.org/plugins/code-snippets/) | code-snippets | 3.4.2 |  | [https://codesnippets.pro](https://codesnippets.pro) |
...
| [Enable Media Replace](https://wordpress.org/plugins/enable-media-replace/) | enable-media-replace | 4.1.2 |  | [https://wordpress.org/plugins/enable-media-replace/](https://wordpress.org/plugins/enable-media-replace/) |
...
| [Faust.js](https://wordpress.org/plugins/faustwp/) | faustwp | 1.0.3 |  | [https://faustjs.org/](https://faustjs.org/) |
...
| [RSS Importer](https://wordpress.org/plugins/rss-importer/) | rss-importer | 0.3.1 |  | [http://wordpress.org/extend/plugins/rss-importer/](http://wordpress.org/extend/plugins/rss-importer/) |
| [Safe SVG](https://wordpress.org/plugins/safe-svg/) | safe-svg | 2.2.0 |  | [https://wordpress.org/plugins/safe-svg/](https://wordpress.org/plugins/safe-svg/) |
...
| [TablePress &#8211; Tables in WordPress made easy](https://wordpress.org/plugins/tablepress/) | tablepress | 2.1.7 |  | [https://tablepress.org/](https://tablepress.org/) |
| [The Events Calendar](https://wordpress.org/plugins/the-events-calendar/) | the-events-calendar | 6.2.0.1 |  | []() |
| [User Role Editor](https://wordpress.org/plugins/user-role-editor/) | user-role-editor | 4.64 |  | [https://www.role-editor.com](https://www.role-editor.com) |
...
| [WordPress Importer](https://wordpress.org/plugins/wordpress-importer/) | wordpress-importer | 0.8.1 |  | [https://wordpress.org/plugins/wordpress-importer/](https://wordpress.org/plugins/wordpress-importer/) |
| [WP REST API Controller](https://wordpress.org/plugins/wp-rest-api-controller/) | wp-rest-api-controller | 2.1.2 |  | []() |
| [WP REST Cache](https://wordpress.org/plugins/wp-rest-cache/) | wp-rest-cache | 2023.2.1 |  | [https://www.acato.nl](https://www.acato.nl) |
| [Categories to Tags Converter](https://wordpress.org/plugins/wpcat2tag-importer/) | wpcat2tag-importer | 0.6.1 |  | [http://wordpress.org/extend/plugins/wpcat2tag-importer/](http://wordpress.org/extend/plugins/wpcat2tag-importer/) |
...
| [WPGraphQL](https://wordpress.org/plugins/wp-graphql/) | wp-graphql | 1.16.0 |  | [https://github.com/wp-graphql/wp-graphql](https://github.com/wp-graphql/wp-graphql) |
| [WP Search with Algolia](https://wordpress.org/plugins/wp-search-with-algolia/) | wp-search-with-algolia | 2.6.0 |  | [https://github.com/WebDevStudios/wp-search-with-algolia](https://github.com/WebDevStudios/wp-search-with-algolia) |
| [Login Lockdown &#8211; Protect Login Form](https://wordpress.org/plugins/login-lockdown/) | login-lockdown | 2.06 | True | [https://wploginlockdown.com/](https://wploginlockdown.com/) |
| [Polylang](https://wordpress.org/plugins/polylang/) | polylang | 3.4.5 | True | [https://polylang.pro](https://polylang.pro) |
...
| [WooCommerce](https://wordpress.org/plugins/woocommerce/) | woocommerce | 8.0.3 | True | [https://woocommerce.com/](https://woocommerce.com/) |
...
| wp-graphql-woocommerce | v0.16.0 | True | [https://github.com/wp-graphql/wp-graphql-woocommerce](https://github.com/wp-graphql/wp-graphql-woocommerce) |
